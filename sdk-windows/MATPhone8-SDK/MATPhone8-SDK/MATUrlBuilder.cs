...
namespace MobileAppTracking 
{
    public class MATUrlBuilder
    {
        ...
        private const string SDK_VERSION = "3.3.2";

        internal static URLInfo BuildUrl(string action, string eventName, double revenue, string currency, string refId, List<MATEventItem> eventItems, Parameters parameters)
        {
