...
- (NSDictionary *)dictionary
{
    ...
    [dict setValue:[NSString stringWithFormat:@"%f", [self unitPrice]] forKey:TUNE_KEY_UNIT_PRICE];
    [dict setValue:[NSString stringWithFormat:@"%d", [self quantity]] forKey:TUNE_KEY_QUANTITY];
    [dict setValue:[NSString stringWithFormat:@"%f", [self revenue]] forKey:TUNE_KEY_REVENUE];
