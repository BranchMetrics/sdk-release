...
+ (void)sendEvent:(TuneEvent *)event parameters:(TuneSettings*)parameters limitEventAndDataUsage:(BOOL)limit
{
...
#pragma clang diagnostic pop
    ...
    if( ![FBAppEvents class] ) {
        DLog( @"TuneFBBridge no FBAppEvents/FBSDKAppEvents class" );
...
#pragma clang diagnostic pop
    ...
    if(parameters.referralSource)
        dict[TUNE_REFERRAL_SOURCE] = parameters.referralSource;
...
#pragma clang diagnostic pop
        ...
        DLog(@"TuneFBBridge logging event %@", fbEventName);
