...
- (void)checkSwizzledMethod:(NSString *)expectedSwizzledMethod {
    if (expectedSwizzledMethod == nil) {
        XCTAssertTrue(expectedSwizzledMethod == tune_swizzledMethod);
    } else {
        XCTAssertTrue([expectedSwizzledMethod isEqualToString:tune_swizzledMethod]);
    }
}
