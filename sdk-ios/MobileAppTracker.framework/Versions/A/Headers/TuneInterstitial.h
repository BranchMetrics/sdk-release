 ...
 */
@interface TuneInterstitial : UIView <TuneAdView>
...
/*!
 Method to create a new ad view with the specified ad type, delegate, orientation and adRequest. This method immediately starts fetching a new ad and sends an appropriate callback to the delegate as soon as the fetch request completes.
 @param adViewDelegate A delegate used by TuneAdView to post success and failure callbacks
...
/*!
 Method to be called in order to display the next interstitial ad using the provided view controller. To be used only for TuneAdTypeInterstitial ads.
 @param placement Ad view placement info, e.g. "menu_page", "highscores", "game-end"
 */
