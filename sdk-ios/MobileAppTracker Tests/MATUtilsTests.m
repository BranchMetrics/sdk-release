...
{
    NSDictionary *item1 = [NSDictionary dictionaryWithObjects:[NSArray arrayWithObjects:@"item1", [NSNumber numberWithInt:1], [NSNumber numberWithFloat:2.99f], [NSNumber numberWithFloat:2.99f], @"attr1", @"attr2", @"attr3", @"attr4", @"attr5", nil]
